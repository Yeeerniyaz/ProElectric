...
export const createTables = async () => {
    try {
        console.log('🔄 [DB Schema] Запуск проверки целостности структуры базы данных...');
        ...
        await query(`
            CREATE TABLE IF NOT EXISTS accounts (
                ...
                type VARCHAR(50) DEFAULT 'cash',      -- Тип: 'cash', 'bank', 'crypto', 'virtual'
        ...
        console.log('✅ [DB Schema] Структура базы данных успешно синхронизирована (версия 2.0.0).');
        
    } catch (error) {
        console.error('❌ [DB Schema] Критическая ошибка при инициализации схемы:', error);
        console.error('⚠️ Совет: Проверьте настройки подключения в .env и доступность PostgreSQL.');
